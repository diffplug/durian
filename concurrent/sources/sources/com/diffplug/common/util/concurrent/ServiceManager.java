...
import static com.diffplug.common.base.Predicates.equalTo;
import static com.diffplug.common.base.Predicates.in;
import static com.diffplug.common.base.Predicates.instanceOf;
...
import static com.diffplug.common.util.concurrent.Service.State.FAILED;
import static com.diffplug.common.util.concurrent.Service.State.NEW;
import static com.diffplug.common.util.concurrent.Service.State.RUNNING;
import static com.diffplug.common.util.concurrent.Service.State.STARTING;
import static com.diffplug.common.util.concurrent.Service.State.STOPPING;
import static com.diffplug.common.util.concurrent.Service.State.TERMINATED;
...
import com.diffplug.common.collect.MultimapBuilder;
...
import com.diffplug.common.util.concurrent.ListenerCallQueue.Callback;
import com.diffplug.common.util.concurrent.Service.State;
...
public final class ServiceManager {
	...
	private static final class ServiceManagerState {
		...
		@GuardedBy("monitor")
		final List<ListenerCallQueue<Listener>> listeners = Collections.synchronizedList(new ArrayList<ListenerCallQueue<Listener>>());
