...
import static com.diffplug.common.base.Throwables.propagateIfInstanceOf;
import static com.diffplug.common.collect.Iterables.getOnlyElement;
import static com.diffplug.common.util.concurrent.Futures.allAsList;
import static com.diffplug.common.util.concurrent.Futures.immediateFailedFuture;
import static com.diffplug.common.util.concurrent.Futures.immediateFuture;
import static com.diffplug.common.util.concurrent.Futures.successfulAsList;
import static com.diffplug.common.util.concurrent.MoreExecutors.directExecutor;
import static com.diffplug.common.util.concurrent.MoreExecutors.newDirectExecutorService;
import static com.diffplug.common.util.concurrent.TestPlatform.clearInterrupt;
import static com.diffplug.common.util.concurrent.Uninterruptibles.awaitUninterruptibly;
...
import com.diffplug.common.testing.TestLogHandler;
...
public class FuturesTest extends TestCase {
	...
	public void testImmediateFailedCheckedFuture() throws Exception {
		...
		CheckedFuture<String, MyException> future = Futures.immediateFailedCheckedFuture(exception);
	...
	public void testTransform_genericsNull() throws Exception {
		...
		ListenableFuture<?> transformedFuture = Futures.transform(nullFuture, Functions.constant(null));
	...
	public void testTransformAsync_interruptPropagatesToTransformingThread() throws Exception {
		...
		ListenableFuture<String> futureResult = Futures.transformAsync(input, function, newSingleThreadExecutor());
	...
	public void testLazyTransform() throws Exception {
		FunctionSpy<Object, String> spy = new FunctionSpy<Object, String>(Functions.constant("bar"));
	...
	public void testCatchingAsync_inputDoesNotRaiseException() throws Exception {
		...
		ListenableFuture<Integer> originalFuture = Futures.immediateFuture(7);
		ListenableFuture<Integer> faultToleranteFuture = Futures.catchingAsync(originalFuture, Throwable.class, fallback);
		assertEquals(7, faultToleranteFuture.get().intValue());
	}
	...
	public void testCatching_inputDoesNotRaiseException() throws Exception {
		...
		ListenableFuture<Integer> originalFuture = Futures.immediateFuture(7);
		ListenableFuture<Integer> faultToleranteFuture = Futures.catching(originalFuture, Throwable.class, fallback);
		assertEquals(7, faultToleranteFuture.get().intValue());
	}
	...
	public void testCatching_inputRaisesException() throws Exception {
		...
		ListenableFuture<Integer> failingFuture = Futures.immediateFailedFuture(raisedException);
		ListenableFuture<Integer> faultTolerantFuture = Futures.catching(failingFuture, Throwable.class, fallback);
		assertEquals(20, faultTolerantFuture.get().intValue());
		fallback.verifyCallCount(1);
	}
	...
	public void testCatching_Throwable() throws Exception {
		...
		ListenableFuture<Integer> faultTolerantFuture = Futures.catching(originalFuture, Throwable.class, fallback);
	...
	public void testCatching_customTypeMatch() throws Exception {
		...
		ListenableFuture<Integer> faultTolerantFuture = Futures.catching(originalFuture, IOException.class, fallback);
		assertEquals(1, (int) faultTolerantFuture.get());
	}
	...
	public void testCatchingAsync_Throwable() throws Exception {
		...
		ListenableFuture<Integer> originalFuture = immediateFailedFuture(new IOException());
		ListenableFuture<Integer> faultTolerantFuture = Futures.catchingAsync(originalFuture, Throwable.class, fallback);
		assertEquals(1, (int) faultTolerantFuture.get());
	}
	...
	public void testCatchingAsync_customTypeMatch() throws Exception {
		...
		ListenableFuture<Integer> originalFuture = immediateFailedFuture(new FileNotFoundException());
		ListenableFuture<Integer> faultTolerantFuture = Futures.catchingAsync(originalFuture, IOException.class, fallback);
		assertEquals(1, (int) faultTolerantFuture.get());
	}
	...
	public void testAllAsList() throws Exception {
		...
		ListenableFuture<List<String>> compound = Futures.allAsList(future1, future2, future3);
	...
	public void testAllAsList_failure() throws Exception {
		...
		SettableFuture<String> future2 = SettableFuture.create();
		@SuppressWarnings("unchecked") // array is never modified
		ListenableFuture<List<String>> compound = Futures.allAsList(future1, future2);
		compound.addListener(listener, directExecutor());
	...
	public void testAllAsList_resultCancelledInterrupted_withSecondaryListFuture()
		...
		ListenableFuture<List<String>> otherCompound = Futures.allAsList(future1, future2);
	...
	private static final class TestFutureBatch {
		 ...
		 */
		final ImmutableList<TestFuture> allFutures = ImmutableList.of(new TestFuture(doneSuccess, "doneSuccess", doNothing),
	...
	public void testSuccessfulAsList() throws Exception {
		...
		SettableFuture<String> future3 = SettableFuture.create();
		@SuppressWarnings("unchecked") // array is never modified
		ListenableFuture<List<String>> compound = Futures.successfulAsList(future1, future2, future3);
	...
	public void testSuccessfulAsList_partialFailure() throws Exception {
		...
		SettableFuture<String> future2 = SettableFuture.create();
		@SuppressWarnings("unchecked") // array is never modified
		ListenableFuture<List<String>> compound = Futures.successfulAsList(future1, future2);
		compound.addListener(listener, directExecutor());
