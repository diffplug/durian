...
import com.diffplug.common.util.concurrent.ForwardingFuture.SimpleForwardingFuture;
...
final class FuturesGetCheckedInputs {
	...
	static final Future<String> RUNTIME_EXCEPTION_FUTURE = new SimpleForwardingFuture<String>(FAILED_FUTURE_CHECKED_EXCEPTION) {
		@Override
		public String get() {
