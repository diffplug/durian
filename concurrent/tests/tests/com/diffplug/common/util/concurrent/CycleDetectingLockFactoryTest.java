...
import com.diffplug.common.util.concurrent.CycleDetectingLockFactory.Policies;
import com.diffplug.common.util.concurrent.CycleDetectingLockFactory.Policy;
import com.diffplug.common.util.concurrent.CycleDetectingLockFactory.PotentialDeadlockException;
...
public class CycleDetectingLockFactoryTest extends TestCase {
	...
	private <E extends Enum<E>> CycleDetectingLockFactory.WithExplicitOrdering<E> newInstanceWithExplicitOrdering(Class<E> enumClass, Policy policy) {
