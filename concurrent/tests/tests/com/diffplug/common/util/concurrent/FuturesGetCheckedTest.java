...
import static com.diffplug.common.util.concurrent.Futures.getChecked;
import static com.diffplug.common.util.concurrent.Futures.immediateFuture;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.CHECKED_EXCEPTION;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.ERROR;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.FAILED_FUTURE_CHECKED_EXCEPTION;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.FAILED_FUTURE_ERROR;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.FAILED_FUTURE_OTHER_THROWABLE;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.FAILED_FUTURE_UNCHECKED_EXCEPTION;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.OTHER_THROWABLE;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.RUNTIME_EXCEPTION;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.RUNTIME_EXCEPTION_FUTURE;
import static com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.UNCHECKED_EXCEPTION;
...
import com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.ExceptionWithBadConstructor;
import com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.ExceptionWithGoodAndBadConstructor;
import com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.ExceptionWithManyConstructors;
import com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.ExceptionWithPrivateConstructor;
import com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.ExceptionWithSomePrivateConstructors;
import com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.ExceptionWithWrongTypesConstructor;
import com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.ExceptionWithoutThrowableConstructor;
import com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.TwoArgConstructorException;
import com.diffplug.common.util.concurrent.FuturesGetCheckedInputs.TwoArgConstructorRuntimeException;
