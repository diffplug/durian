...
import com.diffplug.common.util.concurrent.AtomicLongMap;
...
public class HashingTest extends TestCase {
	...
	public void testConsistentHash_linearCongruentialGeneratorCompatibility() {
		int[] golden100 = {0, 55, 62, 8, 45, 59, 86, 97, 82, 59,
	...
	private static final ImmutableTable<HashFunction, String, String> KNOWN_HASHES = ImmutableTable.<HashFunction, String, String> builder()
