 ...
 */
package com.diffplug.common.reflect;
...
public class TypeTokenTest extends TestCase {
	...
	public void testGetSupertype_chained() {
		...
		TypeToken<ListIterable<String>> listIterableType = (TypeToken<ListIterable<String>>) TypeToken.of(StringListIterable.class).getSupertype(ListIterable.class);
		ParameterizedType expectedType = Types.newParameterizedType(Iterable.class,
				Types.newParameterizedType(List.class, String.class));
	...
	public void testGetSupertype_fromWildcard() {
		...
		TypeToken<? extends List<String>> type = (TypeToken<? extends List<String>>) TypeToken.of(Types.subtypeOf(new TypeToken<List<String>>() {}.getType()));
	...
	public void testGetSubtype_fromWildcard() {
		@SuppressWarnings("unchecked") // can't do new TypeToken<? extends ...>() {}
		TypeToken<? super Iterable<String>> type = (TypeToken<? super Iterable<String>>) TypeToken.of(Types.supertypeOf(new TypeToken<Iterable<String>>() {}.getType()));
	...
	public void testGetSubtype_fromWildcard_lowerBoundNotSupertype() {
		@SuppressWarnings("unchecked") // can't do new TypeToken<? extends ...>() {}
		TypeToken<? super Iterable<String>> type = (TypeToken<? super Iterable<String>>) TypeToken.of(Types.supertypeOf(new TypeToken<ImmutableList<String>>() {}.getType()));
		try {
	...
	public void testGetSubtype_fromWildcard_upperBounded() {
		@SuppressWarnings("unchecked") // can't do new TypeToken<? extends ...>() {}
		TypeToken<? extends Iterable<String>> type = (TypeToken<? extends Iterable<String>>) TypeToken.of(Types.subtypeOf(new TypeToken<Iterable<String>>() {}.getType()));
		try {
	...
	public void testGetSubtype_toWildcard() {
		TypeToken<ForGetSubType.TwoTypeArgs<?, ?>> superType = new TypeToken<ForGetSubType.TwoTypeArgs<?, ?>>() {};
		TypeToken<ForGetSubType.StringForFirstTypeArg<String>> subType = new TypeToken<ForGetSubType.StringForFirstTypeArg<String>>() {};
	...
	public void testGetSubtype_innerTypeOfGenericClassTranslatesOwnerTypeVars() {
		TypeToken<ForGetSubType.TwoTypeArgs<?, ?>.InnerType<?, ?>> superType = new TypeToken<ForGetSubType.TwoTypeArgs<?, ?>.InnerType<?, ?>>() {};
		TypeToken<ForGetSubType.StringForFirstTypeArg<Integer>.StringInnerType<Long>> subType = new TypeToken<ForGetSubType.StringForFirstTypeArg<Integer>.StringInnerType<Long>>() {};
		assertTrue(subType.isSubtypeOf(superType));
		TypeToken<ForGetSubType.StringForFirstTypeArg<?>.StringInnerType<?>> expected = new TypeToken<ForGetSubType.StringForFirstTypeArg<?>.StringInnerType<?>>() {};
	...
	public void testGetSubtype_localTypeTranslatesTypeVar() {
		...
		TypeToken<ForGetSubType.TwoTypeArgs<String, String>> superType = new TypeToken<ForGetSubType.TwoTypeArgs<String, String>>() {};
	...
	public void testGetSubtype_outerTypeVarTranslatesInnerTypeVar() {
		TypeToken<ForGetSubType.StringForFirstTypeArg<List<?>>> type = new TypeToken<ForGetSubType.StringForFirstTypeArg<List<?>>>() {};
	...
	public void testGetSubtype_toWildcardWithBounds() {
		TypeToken<ForGetSubType.TwoTypeArgs<?, ? extends Number>> superType = new TypeToken<ForGetSubType.TwoTypeArgs<?, ? extends Number>>() {};
		TypeToken<ForGetSubType.StringForFirstTypeArg<Integer>> subType = new TypeToken<ForGetSubType.StringForFirstTypeArg<Integer>>() {};
		assertTrue(subType.isSubtypeOf(superType));
	...
	public void testGetSubtype_baseClassWithNoTypeArgs() {
		...
		TypeToken<ForGetSubType.SingleGenericExtendsBase<String>> subType = new TypeToken<ForGetSubType.SingleGenericExtendsBase<String>>() {};
		assertTrue(subType.isSubtypeOf(superType));
	...
	public void testGetSubtype_baseClassWithLessTypeArgs() {
		TypeToken<ForGetSubType.SingleGenericExtendsBase<?>> superType = new TypeToken<ForGetSubType.SingleGenericExtendsBase<?>>() {};
		TypeToken<ForGetSubType.DoubleGenericExtendsSingleGeneric<String, Integer>> subType = new TypeToken<ForGetSubType.DoubleGenericExtendsSingleGeneric<String, Integer>>() {};
		assertTrue(subType.isSubtypeOf(superType));
	...
	public <T> void testGetSubtype_manyGenericArgs() {
		TypeToken<ForGetSubType.FourTypeArgs<T, Integer, ?, ?>> superType = new TypeToken<ForGetSubType.FourTypeArgs<T, Integer, ?, ?>>() {};
		TypeToken<ForGetSubType.ThreeTypeArgs<T, Integer, String>> subType = new TypeToken<ForGetSubType.ThreeTypeArgs<T, Integer, String>>() {};
		assertTrue(subType.isSubtypeOf(superType));
