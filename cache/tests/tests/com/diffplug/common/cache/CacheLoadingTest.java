...
import static com.diffplug.common.cache.TestingCacheLoaders.bulkLoader;
import static com.diffplug.common.cache.TestingCacheLoaders.constantLoader;
import static com.diffplug.common.cache.TestingCacheLoaders.errorLoader;
...
import com.diffplug.common.cache.TestingCacheLoaders.IdentityLoader;
...
import com.diffplug.common.util.concurrent.Callables;
...
public class CacheLoadingTest extends TestCase {
	...
	public void ignoreTestExpandDuringRefresh()
			throws InterruptedException, ExecutionException {
		final AtomicInteger callCount = new AtomicInteger();
		// tells the computing thread when to start computing
		final CountDownLatch computeSignal = new CountDownLatch(1);
