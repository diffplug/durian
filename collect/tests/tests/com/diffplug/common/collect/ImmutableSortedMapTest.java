...
import com.diffplug.common.collect.ImmutableSortedMap.Builder;
...
import com.diffplug.common.collect.testing.NavigableMapTestSuiteBuilder;
...
import com.diffplug.common.collect.testing.google.SortedMapGenerators.ImmutableSortedMapCopyOfEntriesGenerator;
import com.diffplug.common.collect.testing.google.SortedMapGenerators.ImmutableSortedMapEntryListGenerator;
import com.diffplug.common.collect.testing.google.SortedMapGenerators.ImmutableSortedMapGenerator;
import com.diffplug.common.collect.testing.google.SortedMapGenerators.ImmutableSortedMapKeyListGenerator;
import com.diffplug.common.collect.testing.google.SortedMapGenerators.ImmutableSortedMapValueListGenerator;
...
public class ImmutableSortedMapTest extends TestCase {
	...
	public static class CreationTests extends TestCase {
		...
		public void testPuttingTheSameKeyTwiceThrowsOnBuild() {
			Builder<String, Integer> builder = ImmutableSortedMap.<String, Integer> naturalOrder()
					.put("one", 1)
		...
		public void testBuilderReverseOrder() {
			ImmutableSortedMap<String, Integer> map = ImmutableSortedMap.<String, Integer> reverseOrder()
					.put("one", 1)
					.put("two", 2)
					.put("three", 3)
					.put("four", 4)
	...
	public void testSubMapInclusiveInclusive() {
		Map<String, Integer> map = ImmutableSortedMap.of("one", 1, "two", 2, "three", 3).subMap("one", true, "two", true);
		assertThat(map.entrySet()).containsExactly(Maps.immutableEntry("one", 1),
