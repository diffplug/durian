...
import com.diffplug.common.collect.testing.google.ListGenerators.CharactersOfCharSequenceGenerator;
import com.diffplug.common.collect.testing.google.ListGenerators.CharactersOfStringGenerator;
...
public class ListsTest extends TestCase {
	...
	private static void assertTransformListIterator(List<String> list) {
		...
		} catch (UnsupportedOperationException expected) {} catch (IllegalStateException expected) {}
		try {
			iterator.set("1");
