...
import static com.diffplug.common.collect.testing.features.MapFeature.ALLOWS_ANY_NULL_QUERIES;
...
import com.diffplug.common.collect.ImmutableListMultimap.Builder;
...
public class ImmutableListMultimapTest extends TestCase {
	...
	public void testInverseMinimizesWork() {
		ImmutableListMultimap<String, Character> multimap = ImmutableListMultimap.<String, Character> builder()
				.put("foo", 'f')
				.put("foo", 'o')
				.put("foo", 'o')
				.put("poo", 'p')
