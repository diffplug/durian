...
import static com.diffplug.common.collect.Lists.transform;
import static com.diffplug.common.collect.Sets.difference;
...
public class FauxveridesTest extends TestCase {
	...
	private static final class TypeSignature {
		...
		TypeSignature(TypeVariable<Method>[] parameters) {
			parameterSignatures = transform(Arrays.asList(parameters),
