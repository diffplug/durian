...
import static com.diffplug.common.collect.testing.Helpers.nefariousMapEntry;
import static com.diffplug.common.collect.testing.IteratorFeature.MODIFIABLE;
...
public class MultimapsTest extends TestCase {
	...
	public void testSerializingUnmodifiableHashMultimap() {
		Multimap<String, Integer> unmodifiable = prepareUnmodifiableTests(HashMultimap.<String, Integer> create(), false, null, null);
		SerializableTester.reserializeAndAssert(unmodifiable);
	}
	...
	public void testSerializingUnmodifiableTreeMultimap() {
		Multimap<String, Integer> unmodifiable = prepareUnmodifiableTests(TreeMultimap.<String, Integer> create(), false, "null", 42);
		SerializableTester.reserializeAndAssert(unmodifiable);
	}
	...
	public void testSerializingUnmodifiableSynchronizedArrayListMultimap() {
		Multimap<String, Integer> unmodifiable = prepareUnmodifiableTests(Multimaps.synchronizedListMultimap(
	...
	public void testSerializingUnmodifiableSynchronizedHashMultimap() {
		Multimap<String, Integer> unmodifiable = prepareUnmodifiableTests(Multimaps.synchronizedSetMultimap(
	...
	public void testInvertFrom() {
		...
		ImmutableMultimap<Integer, String> single = new ImmutableMultimap.Builder<Integer, String>()
				.put(1, "one")
				.put(2, "two")
				.build();
		...
		ImmutableMultimap<String, Integer> expected = new ImmutableMultimap.Builder<String, Integer>()
				.put("one", 1)
				.put("two", 2)
				.build();
	...
	public void testForMap() {
		...
		multimap2.put("bar", 1);
		assertFalse(multimapView.equals(multimap2));
		ListMultimap<String, Integer> listMultimap = new ImmutableListMultimap.Builder<String, Integer>()
	...
	public void testForMapGetIteration() {
		IteratorTester<Integer> tester = new IteratorTester<Integer>(4, MODIFIABLE, newHashSet(1),
	...
	public void testIndex() {
		final Multimap<String, Object> stringToObject = new ImmutableMultimap.Builder<String, Object>()
				.put("1", 1)
				.put("1", 1L)
				.put("1", "1")
				.put("2", 2)
		...
		ImmutableMultimap<String, Object> outputMap = Multimaps.index(stringToObject.values(),
	...
	public void testIndexIterator() {
		...
		ImmutableMultimap<String, Object> outputMap = Multimaps.index(stringToObject.values().iterator(),
				Functions.toStringFunction());
		assertEquals(stringToObject, outputMap);
	}
