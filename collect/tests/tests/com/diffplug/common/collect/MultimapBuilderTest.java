...
import com.diffplug.common.collect.MultimapBuilder.MultimapBuilderWithKeys;
...
public class MultimapBuilderTest extends TestCase {
	...
	public void testGenerics_gwtCompatible() {
		...
		SortedSetMultimap<String, Integer> b = MultimapBuilder.linkedHashKeys().treeSetValues().<String, Integer> build();
