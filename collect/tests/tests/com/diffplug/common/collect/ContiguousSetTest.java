...
import static com.diffplug.common.collect.BoundType.CLOSED;
import static com.diffplug.common.collect.BoundType.OPEN;
import static com.diffplug.common.collect.DiscreteDomain.integers;
...
import static com.diffplug.common.collect.testing.features.CollectionFeature.NON_STANDARD_TOSTRING;
import static com.diffplug.common.collect.testing.features.CollectionFeature.RESTRICTS_ELEMENTS;
import static com.diffplug.common.collect.testing.testers.NavigableSetNavigationTester.getHoleMethods;
import static com.diffplug.common.testing.SerializableTester.reserialize;
...
import com.diffplug.common.collect.testing.google.SetGenerators.ContiguousSetDescendingGenerator;
import com.diffplug.common.collect.testing.google.SetGenerators.ContiguousSetGenerator;
import com.diffplug.common.collect.testing.google.SetGenerators.ContiguousSetHeadsetGenerator;
import com.diffplug.common.collect.testing.google.SetGenerators.ContiguousSetSubsetGenerator;
import com.diffplug.common.collect.testing.google.SetGenerators.ContiguousSetTailsetGenerator;
