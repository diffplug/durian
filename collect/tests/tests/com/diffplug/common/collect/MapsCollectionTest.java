...
import com.diffplug.common.collect.testing.SafeTreeMap;
import com.diffplug.common.collect.testing.SampleElements;
import com.diffplug.common.collect.testing.SortedMapTestSuiteBuilder;
...
import com.diffplug.common.collect.testing.TestStringSortedMapGenerator;
...
import com.diffplug.common.collect.testing.google.BiMapTestSuiteBuilder;
import com.diffplug.common.collect.testing.google.TestStringBiMapGenerator;
...
public class MapsCollectionTest extends TestCase {
	...
	private static final EntryTransformer<String, String, String> DECODE_ENTRY_TRANSFORMER = new EntryTransformer<String, String, String>() {
		@Override
