...
import static com.diffplug.common.collect.Maps.newHashMap;
...
import static com.diffplug.common.collect.testing.google.AbstractMultisetSetCountTester.getSetCountDuplicateInitializingMethods;
import static com.diffplug.common.collect.testing.google.MultisetCountTester.getCountDuplicateInitializingMethods;
import static com.diffplug.common.collect.testing.google.MultisetIteratorTester.getIteratorDuplicateInitializingMethods;
import static com.diffplug.common.collect.testing.google.MultisetRemoveTester.getRemoveDuplicateInitializingMethods;
...
import com.diffplug.common.collect.testing.TestStringSetGenerator;
...
import com.diffplug.common.collect.testing.google.ListMultimapTestSuiteBuilder;
import com.diffplug.common.collect.testing.google.MultimapFeature;
import com.diffplug.common.collect.testing.google.MultimapTestSuiteBuilder;
import com.diffplug.common.collect.testing.google.MultisetTestSuiteBuilder;
import com.diffplug.common.collect.testing.google.SetMultimapTestSuiteBuilder;
import com.diffplug.common.collect.testing.google.TestListMultimapGenerator;
import com.diffplug.common.collect.testing.google.TestMultimapGenerator;
import com.diffplug.common.collect.testing.google.TestSetMultimapGenerator;
import com.diffplug.common.collect.testing.google.TestStringListMultimapGenerator;
import com.diffplug.common.collect.testing.google.TestStringMultisetGenerator;
...
public class MultimapsCollectionTest extends TestCase {
	...
	static abstract class TransformedMultimapGenerator<M extends Multimap<String, String>>
		...
		static final EntryTransformer<String, String, String> ENTRY_TRANSFORMER = new EntryTransformer<String, String, String>() {
			@Override
