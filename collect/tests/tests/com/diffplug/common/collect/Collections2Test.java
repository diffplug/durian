...
import static com.diffplug.common.collect.Iterables.concat;
import static com.diffplug.common.collect.Lists.newArrayList;
import static com.diffplug.common.collect.Lists.newLinkedList;
...
public class Collections2Test extends TestCase {
	...
	public void testPermutationSetOneElement() {
		Iterator<List<Integer>> permutations = Collections2.permutations(Collections.<Integer> singletonList(1))
				.iterator();
		assertNextPermutation(newArrayList(1), permutations);
		assertNoMorePermutations(permutations);
	}
