...
import com.diffplug.common.collect.ImmutableBiMap.Builder;
...
import com.diffplug.common.collect.testing.google.BiMapGenerators.ImmutableBiMapCopyOfEntriesGenerator;
import com.diffplug.common.collect.testing.google.BiMapGenerators.ImmutableBiMapCopyOfGenerator;
import com.diffplug.common.collect.testing.google.BiMapGenerators.ImmutableBiMapGenerator;
import com.diffplug.common.collect.testing.google.BiMapInverseTester;
...
public class ImmutableBiMapTest extends TestCase {
	...
	public static class CreationTests extends TestCase {
		...
		public void testBuilder_orderEntriesByValueAfterExactSizeBuild() {
			ImmutableBiMap.Builder<String, Integer> builder = new ImmutableBiMap.Builder<String, Integer>(2).put("four", 4).put("one", 1);
