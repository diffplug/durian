...
import static com.diffplug.common.collect.Iterables.unmodifiableIterable;
...
import com.diffplug.common.collect.testing.MinimalIterable;
import com.diffplug.common.collect.testing.features.CollectionSize;
import com.diffplug.common.collect.testing.google.ListGenerators.BuilderAddAllListGenerator;
import com.diffplug.common.collect.testing.google.ListGenerators.BuilderReversedListGenerator;
import com.diffplug.common.collect.testing.google.ListGenerators.ImmutableListHeadSubListGenerator;
import com.diffplug.common.collect.testing.google.ListGenerators.ImmutableListMiddleSubListGenerator;
import com.diffplug.common.collect.testing.google.ListGenerators.ImmutableListOfGenerator;
import com.diffplug.common.collect.testing.google.ListGenerators.ImmutableListTailSubListGenerator;
import com.diffplug.common.collect.testing.google.ListGenerators.UnhashableElementsImmutableListGenerator;
...
public class ImmutableListTest extends TestCase {
	...
	public static class ConcurrentTests extends TestCase {
		...
		private static void runConcurrentlyMutatedTest(
			...
			ConcurrentlyMutatedList<Integer> concurrentlyMutatedList = newConcurrentlyMutatedList(
