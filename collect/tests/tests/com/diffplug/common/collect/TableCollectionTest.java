...
import com.diffplug.common.collect.testing.SortedSetTestSuiteBuilder;
	...
	public static Test suite() {
		...
		suite.addTest(SetTestSuiteBuilder.using(new TestStringSetGenerator() {
			...
			protected Set<String> create(String[] elements) {
				Table<String, Integer, Character> table = ArrayTable.create(
		...
		suite.addTest(SetTestSuiteBuilder.using(new TestStringSetGenerator() {
			@Override
			protected Set<String> create(String[] elements) {
				Table<Integer, String, Character> table = ArrayTable.create(
