...
import static com.diffplug.common.collect.MapMakerInternalMap.DRAIN_THRESHOLD;
import static com.diffplug.common.collect.MapMakerInternalMapTest.SMALL_MAX_SIZE;
import static com.diffplug.common.collect.MapMakerInternalMapTest.allEvictingMakers;
import static com.diffplug.common.collect.MapMakerInternalMapTest.assertNotified;
import static com.diffplug.common.collect.MapMakerInternalMapTest.checkAndDrainRecencyQueue;
import static com.diffplug.common.collect.MapMakerInternalMapTest.checkEvictionQueues;
import static com.diffplug.common.collect.MapMakerInternalMapTest.checkExpirationTimes;
...
import com.diffplug.common.collect.MapMakerInternalMap.Segment;
import com.diffplug.common.collect.MapMakerInternalMapTest.DummyEntry;
import com.diffplug.common.collect.MapMakerInternalMapTest.DummyValueReference;
...
public class ComputingConcurrentHashMapTest extends TestCase {
	...
	public void testComputingFunction() {
		...
		ComputingConcurrentHashMap<Object, Object> map = makeComputingMap(createMapMaker(), computingFunction);
