...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> {
	 ...
	 */
	public static <R, C, V> Builder<R, C, V> builder(int initialCapacity) {
		return new Builder<R, C, V>(initialCapacity);
	}
	...
	public static final class Builder<R, C, V> {
		 ...
		 * is equivalent to the builder generated by {@link ImmutableTable#builder(int)}.
		 */
