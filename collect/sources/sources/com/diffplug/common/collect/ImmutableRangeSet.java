...
import static com.diffplug.common.collect.SortedLists.KeyAbsentBehavior.NEXT_LOWER;
import static com.diffplug.common.collect.SortedLists.KeyPresentBehavior.ANY_PRESENT;
...
import com.diffplug.common.collect.SortedLists.KeyAbsentBehavior;
import com.diffplug.common.collect.SortedLists.KeyPresentBehavior;
...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C>
	...
	private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<Comparable<?>>(ImmutableList.<Range<Comparable<?>>> of());

	private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<Comparable<?>>(ImmutableList.of(Range.<Comparable<?>> all()));
