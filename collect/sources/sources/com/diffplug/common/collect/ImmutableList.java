...
import static com.diffplug.common.base.Preconditions.checkElementIndex;
import static com.diffplug.common.base.Preconditions.checkNotNull;
import static com.diffplug.common.base.Preconditions.checkPositionIndexes;
import static com.diffplug.common.collect.ObjectArrays.arraysCopyOf;
import static com.diffplug.common.collect.ObjectArrays.checkElementsNotNull;
import static com.diffplug.common.collect.RegularImmutableList.EMPTY;
...
public abstract class ImmutableList<E> extends ImmutableCollection<E>
	...
	/**
	 * Returns a new builder with the given initial capacity. The generated builder
	 * is equivalent to the builder created by the {@link Builder#Builder(int)} constructor.
	 */
	public static <E> Builder<E> builder(int initialCapacity) {
		return new Builder<E>(initialCapacity);
	}
	...
	public static final class Builder<E> extends ImmutableCollection.ArrayBasedBuilder<E> {
		...
		/**
		 * Creates a new builder with the given initial capacity. The returned builder
		 * is equivalent to the builder generated by {@link ImmutableList#builder(int)}.
		 */
