...
import static com.diffplug.common.collect.testing.Helpers.equal;
...
public final class DerivedCollectionGenerators {
	...
	public static class MapValueCollectionGenerator<K, V>
		...
		public Iterable<V> order(List<V> insertionOrder) {
			final List<Entry<K, V>> orderedEntries = castOrCopyToList(mapGenerator.order(castOrCopyToList(
