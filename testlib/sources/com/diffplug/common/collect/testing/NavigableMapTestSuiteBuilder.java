...
import static com.diffplug.common.collect.testing.Helpers.castOrCopyToList;
...
import com.diffplug.common.collect.testing.DerivedCollectionGenerators.Bound;
import com.diffplug.common.collect.testing.DerivedCollectionGenerators.ForwardingTestMapGenerator;
import com.diffplug.common.collect.testing.DerivedCollectionGenerators.SortedMapSubmapTestMapGenerator;
import com.diffplug.common.collect.testing.features.Feature;
import com.diffplug.common.collect.testing.testers.NavigableMapNavigationTester;
...
public class NavigableMapTestSuiteBuilder<K, V> extends SortedMapTestSuiteBuilder<K, V> {
	...
	@Override
	protected List<TestSuite> createDerivedSuites(FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<K, V>, Entry<K, V>>> parentBuilder) {
	...
	public static final class NavigableMapSubmapTestMapGenerator<K, V>
		...
		@Override
		NavigableMap<K, V> createSubMap(SortedMap<K, V> sortedMap, K firstExclusive,
				K lastExclusive) {
