...
public enum MapFeature implements Feature<Map> {
	 ...
	 */
	ALLOWS_NULL_KEY_QUERIES, ALLOWS_NULL_KEYS(ALLOWS_NULL_KEY_QUERIES),
	/**
	 * The map does not throw {@code NullPointerException} on calls such as
	 * {@code containsValue(null)}, {@code values().contains(null)} or
	 * {@code values().remove(null)}.
	 */
	ALLOWS_NULL_VALUE_QUERIES, ALLOWS_NULL_VALUES(ALLOWS_NULL_VALUE_QUERIES),
	/**
	 * The map does not throw {@code NullPointerException} on calls such as
	...
	ALLOWS_ANY_NULL_QUERIES(
			...
			ALLOWS_NULL_VALUE_QUERIES), RESTRICTS_KEYS, RESTRICTS_VALUES, SUPPORTS_PUT, SUPPORTS_REMOVE, FAILS_FAST_ON_CONCURRENT_MODIFICATION,
	/**
