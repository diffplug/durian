...
import com.diffplug.common.collect.testing.testers.SortedMapNavigationTester;
...
public class SortedMapTestSuiteBuilder<K, V> extends MapTestSuiteBuilder<K, V> {
	...
	@Override
	protected SetTestSuiteBuilder<K> createDerivedKeySetSuite(
	 ...
	 */
	final TestSuite createSubmapSuite(final FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Map<K, V>, Entry<K, V>>> parentBuilder, final Bound from, final Bound to) {
