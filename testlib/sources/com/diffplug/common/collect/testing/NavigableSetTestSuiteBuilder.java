...
import static com.diffplug.common.collect.testing.features.CollectionFeature.DESCENDING_VIEW;
import static com.diffplug.common.collect.testing.features.CollectionFeature.SUBSET_VIEW;
...
import com.diffplug.common.collect.testing.DerivedCollectionGenerators.SortedSetSubsetTestSetGenerator;
import com.diffplug.common.collect.testing.features.Feature;
import com.diffplug.common.collect.testing.testers.NavigableSetNavigationTester;
...
public final class NavigableSetTestSuiteBuilder<E>
	 ...
	 */
	private TestSuite createDescendingSuite(final FeatureSpecificTestSuiteBuilder<?, ? extends OneSizeTestContainerGenerator<Collection<E>, E>> parentBuilder) {
