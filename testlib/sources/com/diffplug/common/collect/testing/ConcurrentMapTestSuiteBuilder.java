...
import com.diffplug.common.collect.testing.testers.ConcurrentMapPutIfAbsentTester;
import com.diffplug.common.collect.testing.testers.ConcurrentMapRemoveTester;
import com.diffplug.common.collect.testing.testers.ConcurrentMapReplaceEntryTester;
import com.diffplug.common.collect.testing.testers.ConcurrentMapReplaceTester;
...
public class ConcurrentMapTestSuiteBuilder<K, V> extends MapTestSuiteBuilder<K, V> {
	...
	static final List<? extends Class<? extends AbstractTester>> TESTERS = Arrays.asList(
