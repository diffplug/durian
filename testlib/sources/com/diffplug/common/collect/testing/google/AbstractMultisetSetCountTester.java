...
import static com.diffplug.common.collect.testing.features.CollectionFeature.SUPPORTS_ADD;
...
public abstract class AbstractMultisetSetCountTester<E>
	...
	public void testSetCount_noOpNull_nullUnsupported() {
		try {
			assertSetCount(null, 0);
		} catch (NullPointerException tolerated) {} catch (UnsupportedOperationException tolerated) {}
	}
	...
	public void testSetCount_negative_removeUnsupported() {
		...
		} catch (IllegalArgumentException expected) {} catch (UnsupportedOperationException expected) {}
	}
