...
import static com.diffplug.common.collect.Sets.newTreeSet;
import static com.diffplug.common.collect.testing.SampleElements.Strings.AFTER_LAST;
import static com.diffplug.common.collect.testing.SampleElements.Strings.AFTER_LAST_2;
import static com.diffplug.common.collect.testing.SampleElements.Strings.BEFORE_FIRST;
import static com.diffplug.common.collect.testing.SampleElements.Strings.BEFORE_FIRST_2;
...
import com.diffplug.common.collect.ContiguousSet;
import com.diffplug.common.collect.DiscreteDomain;
...
import com.diffplug.common.collect.testing.TestCollidingSetGenerator;
import com.diffplug.common.collect.testing.TestIntegerSortedSetGenerator;
import com.diffplug.common.collect.testing.TestSetGenerator;
...
import com.diffplug.common.collect.testing.TestStringSortedSetGenerator;
import com.diffplug.common.collect.testing.TestUnhashableCollectionGenerator;
...
public class SetGenerators {
	...
	public static class ImmutableSortedSetUnhashableGenerator
		...
		@Override
		public Set<UnhashableObject> create(
