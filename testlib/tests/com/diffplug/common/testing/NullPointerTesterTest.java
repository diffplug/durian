...
import com.diffplug.common.testing.anotherpackage.SomeClassThatDoesNotUseNullable;
...
public class NullPointerTesterTest extends TestCase {
	...
	private static class ConverterDefaultValueChecker
		...
		void check() {
			...
			Converter<String, Integer> defaultConverter = (Converter<String, Integer>) getDefaultParameterValue(0);
