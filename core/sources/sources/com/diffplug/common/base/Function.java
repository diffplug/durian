...
public interface Function<F, T> {
	 ...
	 *     Objects.equal}{@code (a, b)} implies that {@code Objects.equals(function.apply(a),
	 *     function.apply(b))}.
	 * </ul>
	 *
	 ...
	 * <i>typically</i> means that {@code Objects.equals(this.apply(f), that.apply(f))} is true for all
