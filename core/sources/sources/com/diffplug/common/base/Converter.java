 ...
 * an example round-trip using {@link com.diffplug.common.primitives.Doubles#stringConverter}:
 *
 * <ol>
 ...
 *     com.diffplug.common.primitives.Ints#stringConverter Ints.stringConverter} or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using {@link
 *     com.diffplug.common.collect.Maps#asConverter Maps.asConverter}. For example, use this to create
...
public abstract class Converter<A, B> implements Function<A, B>, ConverterNullable<A, B> {
	 ...
	 * <i>typically</i> means that {@code Objects.equals(this.convert(a), that.convert(a))} is true for
