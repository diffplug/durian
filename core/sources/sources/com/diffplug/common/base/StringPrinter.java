...
/**
 * Pipes strings to a {@code Consumer<String>} through an API which unifies
 * {@link OutputStream}, {@link PrintStream}, {@link Writer}, and {@link PrintWriter}.
 *
...
public final class StringPrinter {
	...
	/**
	 * Utility method for creating multi-line strings
	 * (joined with `\n`, never `\r\n`).
	 */
	...
	/**
	 * Calls {@link #toOutputStream(Charset)} with `charset=UTF-8`.
	 */
	public OutputStream toOutputStream() {
		return toOutputStream(StandardCharsets.UTF_8);
	}
	...
	/**
	 * Calls {@link #toPrintStream(Charset)} with `charset=UTF-8`.
	 */
	 ...
	 * ```
	 * 
	 * @param perLine a `Consumer<String>` which will receive strings which were terminated by newlines.
	 *     (the newlines are stripped when they are passed to the consumer)
