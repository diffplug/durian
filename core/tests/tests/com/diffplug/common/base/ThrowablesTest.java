...
import static com.diffplug.common.base.Throwables.getStackTraceAsString;
import static com.diffplug.common.base.Throwables.lazyStackTrace;
import static com.diffplug.common.base.Throwables.lazyStackTraceIsLazy;
...
public class ThrowablesTest extends TestCase {
	...
	public void testPropagateIfPossible_TwoDeclared_NoneThrown()
		...
		Sample sample = new Sample() {
			@Override
			public void twoDeclared() throws SomeCheckedException,
