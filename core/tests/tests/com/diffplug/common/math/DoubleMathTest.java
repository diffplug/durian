...
import static com.diffplug.common.math.MathTesting.ALL_DOUBLE_CANDIDATES;
import static com.diffplug.common.math.MathTesting.ALL_ROUNDING_MODES;
import static com.diffplug.common.math.MathTesting.ALL_SAFE_ROUNDING_MODES;
import static com.diffplug.common.math.MathTesting.DOUBLE_CANDIDATES_EXCEPT_NAN;
import static com.diffplug.common.math.MathTesting.FINITE_DOUBLE_CANDIDATES;
import static com.diffplug.common.math.MathTesting.FRACTIONAL_DOUBLE_CANDIDATES;
import static com.diffplug.common.math.MathTesting.INFINITIES;
import static com.diffplug.common.math.MathTesting.INTEGRAL_DOUBLE_CANDIDATES;
import static com.diffplug.common.math.MathTesting.NEGATIVE_INTEGER_CANDIDATES;
...
public class DoubleMathTest extends TestCase {
	...
	private static final ImmutableList<Double> FINITE_TOLERANCE_CANDIDATES = ImmutableList.of(-0.0, 0.0, 1.0, 100.0, 10000.0, Double.MAX_VALUE);

	private static final Iterable<Double> TOLERANCE_CANDIDATES = Iterables.concat(FINITE_TOLERANCE_CANDIDATES, ImmutableList.of(Double.POSITIVE_INFINITY));

	private static final List<Double> BAD_TOLERANCE_CANDIDATES = Doubles.asList(-Double.MIN_VALUE, -Double.MIN_NORMAL, -1, -20, Double.NaN,
